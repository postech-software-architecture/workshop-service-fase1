...
class ClienteRepositoryImplIT extends PostgresTestContainer {
	...
	void shouldSaveUpdateAndFindCliente() {
		...
		Cliente cliente = new Cliente(id, "Teste Repo", new Documento("98765432100"), "repo@test.com", "11999999999");
		repository.salvar(cliente);

		// Update with address (new)
		cliente.atualizarDados("Novo Nome", "novo@test.com", "11888888888",
