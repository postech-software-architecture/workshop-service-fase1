...
class VeiculoRepositoryImplIT extends PostgresTestContainer {
    ...
    void shouldListFilterAndRespectSoftDelete() {
        ...
        Veiculo veiculoAtivo = veiculoRepository.salvar(new Veiculo(null, new Placa("BRA1D23"), "Toyota", "Corolla", 2020,
                null, null, List.of(clienteId)));
        Veiculo veiculoInativo = veiculoRepository.salvar(new Veiculo(null, new Placa("ABC1234"), "Ford", "Focus", 2018,
                null, null, List.of(outroClienteId)));
    ...
    void shouldReusePlateAfterLogicalRemoval() {
        ...
        Veiculo original = veiculoRepository.salvar(new Veiculo(null, new Placa("BRA1D23"), "Toyota", "Corolla", 2020,
                null, null, List.of(clienteId)));
    ...
    private UUID criarCliente(String nome, String documento) {
        Cliente cliente = new Cliente(UUID.randomUUID(), nome, new Documento(documento), nome.toLowerCase().replace(" ", ".") + "@teste.com", null);
