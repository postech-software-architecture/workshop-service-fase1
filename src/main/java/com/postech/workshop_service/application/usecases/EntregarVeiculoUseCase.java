...
/**
 * Caso de uso responsavel por registrar a entrega do veiculo ao cliente.
 */
@Service
public class EntregarVeiculoUseCase {
	...
	public EntregarVeiculoUseCase(OrdemServicoRepository ordemServicoRepository,
	...
	public OrdemServico executar(UUID idOrdemServico) {
		...
		try {
			...
			if (ordemServicoMetrics != null) {
				ordemServicoMetrics.erroDeProcessamento("finalizacao", "entregar");
			}
			throw ex;
		}
	}
