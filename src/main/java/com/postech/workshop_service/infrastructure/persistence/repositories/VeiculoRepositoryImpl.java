...
public class VeiculoRepositoryImpl implements VeiculoRepository {
    ...
    public Veiculo salvar(Veiculo veiculo) {
        VeiculoJpaEntity entity = jpaVeiculoRepository.findById(veiculo.getId())
                .map(existente -> {
    ...
    @Override
    @Transactional(readOnly = true)
    public PaginaResultado<Veiculo> listar(int pagina, int tamanho, String placaNormalizada, UUID clienteId, boolean incluirInativos) {
    ...
    private Specification<VeiculoJpaEntity> filtrarPor(String placaNormalizada, UUID clienteId, boolean incluirInativos) {
        return (root, query, criteriaBuilder) -> {
            ...
            if (placaNormalizada != null) {
                predicates = criteriaBuilder.and(predicates, criteriaBuilder.equal(root.get("placa"), placaNormalizada));
            }
            if (clienteId != null) {
