...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Dados para cadastro de uma nova peca ou insumo")
public class CadastroPecaRequest {

	@NotBlank(message = "O SKU e obrigatorio")
	@Size(max = 50, message = "O SKU deve ter no maximo 50 caracteres")
	@Schema(example = "FIL-001", description = "Codigo SKU unico da peca")
	private String sku;

	@NotBlank(message = "O nome e obrigatorio")
	@Size(max = 200, message = "O nome deve ter no maximo 200 caracteres")
	@Schema(example = "Filtro de oleo 5W30", description = "Nome ou descricao da peca")
	private String nome;

	@NotNull(message = "O valor unitario e obrigatorio")
	@Positive(message = "O valor unitario deve ser maior que zero")
	@Schema(example = "45.90", description = "Preco unitario da peca")
	private BigDecimal valorUnitario;

	@NotNull(message = "O estoque minimo e obrigatorio")
	@PositiveOrZero(message = "O estoque minimo nao pode ser negativo")
	@Schema(example = "5", description = "Nivel minimo para alerta de reposicao")
